...
#include "cmbott_msgs/action/cmbot_task.hpp"
...
public:
    ...
    : Node("task_server", options)
  {
    ...
    action_server_ = rclcpp_action::create_server<cmbott_msgs::action::CmbotTask>(
...
private:
  rclcpp_action::Server<cmbott_msgs::action::CmbotTask>::SharedPtr action_server_;
  ...
  rclcpp_action::GoalResponse goalCallback(
      ...
      std::shared_ptr<const cmbott_msgs::action::CmbotTask::Goal> goal)
  {
  ...
  rclcpp_action::CancelResponse cancelCallback(
      const std::shared_ptr<rclcpp_action::ServerGoalHandle<cmbott_msgs::action::CmbotTask>> goal_handle)
  {
    (void)goal_handle;
  ...
  void execute(const std::shared_ptr<rclcpp_action::ServerGoalHandle<cmbott_msgs::action::CmbotTask>> goal_handle)
  {
    RCLCPP_INFO(get_logger(), "Executing goal");
    auto result = std::make_shared<cmbott_msgs::action::CmbotTask::Result>();
...
RCLCPP_COMPONENTS_REGISTER_NODE(cmbot_remote::TaskServer)