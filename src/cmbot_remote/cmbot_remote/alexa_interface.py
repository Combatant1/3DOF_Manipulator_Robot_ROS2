...
from cmbott_msgs.action import CmbotTask
import rclpy
...
action_client = ActionClient(Node('alexa_interface'), CmbotTask, "task_server")
...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speech_text = "Initializing combatant manipulator one, how can I help?"
...
class PickIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speech_text = "Roger, picking up the object"
...
class SleepIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speech_text = "Moving to rest position, see you later"
...
skill_adapter = SkillAdapter(
    ...
    skill_id="amzn1.ask.skill.7dce7d25-0f0a-45b7-b028-aef5a33c5855",
    app=app)
